...
namespace Crud_WebAPI.Data
{
    ...
    {
        //DataContext  => Construtor do DataContext recebe o tipo de DataContext e essa base seria o construtor do seu DbContext que vc ta mandando para o seu DataContext
        public DataContext(DbContextOptions<DataContext> options) : base (options) { }   

        //Essas 4 referencias sao as 4 tabelas para realizar os processos de DB.     
        ...
        {
            //A relação de aluno e disciplina tme chave composta de aluno e disciplina N para N
            builder.Entity<AlunoDisciplina>()
                .HasKey(AD => new { AD.AlunoId, AD.DisciplinaId });

            //HasData => Para dizer que tem dados quando criar um novo dado
...
/* 
dotnet ef migrations add initial => Criação do Db. 

Mas antes vc precisa configurar seu banco de dados no arquivo "Startup.cs"

Na função ConfigureServices. Eu add =>
